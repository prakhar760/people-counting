'''A Flask application to run the people counting on a video file or ip cam stream

Authors: Sugandh Gupta and Hamza Aziz
Date: 07/02/2023 
'''
...
app.config['SECRET_KEY'] = 'people_Counting'
